...
public class Node {
	...
	public boolean addAllDaughters(List<Node> daughters) {
		for(Node daughter:daughters){
			daughter.setParent(this);
		}
		return m_lstDaughters.addAll(daughters);
	}

	public boolean removeAllDaughters() {
		return m_lstDaughters.removeAll(m_lstDaughters);
	}
	...
	/**
	 * cStarting from current Node, returned all descending nodes in the tree top-down on it's daughters
	 * @param lst
     * @return
     */
